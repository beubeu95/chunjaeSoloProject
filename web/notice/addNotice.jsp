...
<head>
    ...
    <style>
        ...
        .contents { clear:both; min-height:100vh;
            background-image: url("<%=path20 %>/images/bg_visual_overview.jpg");
    ...
    <link rel="stylesheet" href="<%=path20 %>/css/ft.css">
    <style>
...
<div class="container">
    ...
    <div class="contents" id="contents">
        <div class="breadcrumb">
            <p><a href="/">HOME</a> &gt; <a href="<%=path20 %>/notice/noticeList.jsp">공지사항</a> &gt; <span>공지사항 글쓰기</span></p>
        </div>
